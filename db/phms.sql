...
INSERT INTO `appointment` VALUES (38, 31, 38, 26, '2020-07-02 00:00:00', '111', '2020-07-02 19:13:10', 4, '123', '111');
INSERT INTO `appointment` VALUES (39, 34, 39, NULL, '2021-02-23 00:00:00', '1', '2021-02-23 20:04:11', 1, '1', '1');
INSERT INTO `appointment` VALUES (40, 35, 39, 26, '2024-12-04 00:00:00', '感冒', '2024-12-03 21:27:42', 4, '15312080955', '江苏南京');
...
INSERT INTO `diagnosis` VALUES (21, 31, 38, 26, 'srwer', '2', 1, '2021-02-23 20:03:05');
INSERT INTO `diagnosis` VALUES (22, 35, 39, 26, '因为感染被确认为流感', '2', 1, '2024-12-03 21:30:36');
...
INSERT INTO `notice` VALUES (6, '<p>怎么养宠物....</p>', 13, '2020-04-26 19:46:28', '养犬重要的是什么？');
INSERT INTO `notice` VALUES (8, '<p>宠物</p>', 3, '2020-05-30 10:37:36', '宠物');
...
CREATE TABLE `page`  (
  ...
  `parent_id` int(11) NULL DEFAULT NULL COMMENT '父页面id',
  ...
  `level_type` int(11) NULL DEFAULT NULL COMMENT '页面层级',
  `level_index` int(11) NULL DEFAULT NULL COMMENT '页面索引',
...
INSERT INTO `pet` VALUES (32, 37, 'qwe', 1.00, 11.00, '1', '2021-02-23 00:00:00', NULL, '2021-02-23 19:57:20');
INSERT INTO `pet` VALUES (33, 1, '刘聪', 45.00, 178.00, '2', '2021-02-23 00:00:00', NULL, '2021-02-23 20:01:41');
INSERT INTO `pet` VALUES (34, 39, '1234', 12.00, 123.00, '1', '2021-02-23 00:00:00', NULL, '2021-02-23 20:04:00');
INSERT INTO `pet` VALUES (35, 39, '柯基', 23.00, 110.00, '1', '2024-10-01 00:00:00', NULL, '2024-12-03 21:27:03');
...
INSERT INTO `pet_daily` VALUES (28, 35, 39, 36.00, 12.00, 110.00, 12.00, 1, '2024-12-03 21:35:27');
...
) ENGINE = InnoDB AUTO_INCREMENT = 897 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = COMPACT;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, NULL, 'admin', 'e10adc3949ba59abbe56e057f20f883e', '555@qq.com', '222222222222222222', NULL, NULL, NULL, NULL, '总经理', NULL, NULL, '18888889998', '222', NULL);
